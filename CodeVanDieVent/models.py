...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        # conv_dim = 32
        self.deconv1 = deconv(noise_size, 128, 4, stride=1, padding=0)
        self.deconv2 = deconv(128, 64, 4)
        self.deconv3 = deconv(64, conv_dim, 4)
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False):
        ...
        self.conv2 = conv(32, conv_dim, 4)

        # 2. Define the transformation part of the generator
        self.resnet_block = ResnetBlock(conv_dim)

        # 3. Define the decoder part of the generator (that builds up the output image from features)
        self.deconv1 = deconv(conv_dim, 32, 4)
        self.deconv2 = deconv(32, 3, 4)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv1 = conv(3, 32, 4)
        self.conv2 = conv(32, conv_dim, 4) # maybe padding = 3
        self.conv3 = conv(conv_dim, 128, 4)
