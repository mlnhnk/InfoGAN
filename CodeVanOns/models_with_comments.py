...
class Recognition(nn.Module):
    ...
    def forward(self, x):
        ...
        print("Cat_out: ", cat_out.size())
        cont_mu_out = self.cont_mu_fc(out)
        print("Cont_out: ", cont_mu_out.size())
        cont_sigma_out = self.cont_sigma_fc(out)
        print("Cont_out: ", cont_sigma_out.size())
